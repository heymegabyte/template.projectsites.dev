...
const V = {
  ...
  dental: {
    hero: ['Gentle dental care for your whole family', 'From routine cleanings to same-day emergencies, we keep every smile healthy and comfortable at every visit. Whether you need a six-month checkup, a filling, a brighter smile, or fast help when a tooth is aching, our gentle team explains your options in plain language and works at your pace. We care for kids, parents, and grandparents alike, and new patients are always welcome.', 'Book a visit', 'See services'],
    ...
    about: ['Care that treats you like family', 'Our team blends modern dentistry with an old-fashioned bedside manner. We take the time to listen, explain what we see in plain language, and make every visit calm and unhurried, because good care starts with feeling heard. From your first cleaning to a bigger treatment plan, you work with people who know your name, remember your history, and genuinely want to keep your smile healthy for life.', 'Our promise to you', 'Honest recommendations, gentle hands, and a healthy smile that lasts. That is the standard we hold on every single visit.'],
  ...
  wellness: {
    hero: ['Move, breathe, and feel restored', 'A welcoming studio for every body and every level, where beginners and longtime practitioners share the same calm, judgment-free space. Whether you want to build strength, quiet a busy mind, or simply move a little more, our teachers meet you exactly where you are. Roll out a mat, take a breath, and find a community that genuinely cheers you on.', 'Start your first class', 'View schedule'],
    ...
    about: ['A studio built for real people', 'We created a calm, welcoming space where anyone can build strength and find a little balance, no matter where they are starting from. There are no cliques and no pressure to look a certain way or touch your toes on day one, just good movement, patient teaching, and good company. Come exactly as you are, breathe, and let the practice meet you where you need it.', 'Why we teach', 'We believe a steady practice changes lives, one breath at a time. Our mission is to make that practice feel like home.'],
  ...
  nonprofit: {
    hero: ['Together, we can do more', 'Every gift and every volunteer hour creates real, lasting change for our neighbors, from warm meals and mentoring for kids to a steady hand up in the hardest moments. The large majority of every dollar stays right here and goes straight to the people who need it most. Join us, roll up your sleeves, and see the difference you make firsthand.', 'Donate now', 'Get involved'],
    ...
    about: ['Neighbors helping neighbors', 'We are a community of donors, volunteers, and staff united by one simple belief: everyone deserves care, dignity, and a real chance to get back on their feet. Together, we turn that belief into action every single day, meal by meal and neighbor by neighbor. We are not here to hand out judgment; we are here to hand up help, and to stay until it truly makes a difference.', 'Our mission', 'To meet urgent needs today and build a stronger, more caring community for tomorrow, one neighbor at a time.'],
  ...
  retail: {
    hero: ['Built for how you live', 'Quality goods, honest prices, and fast, free shipping on orders over $50. Every piece we carry is chosen to last and backed by a team that actually uses it, so you get straight recommendations instead of a hard sell. Not the right fit? Easy 30-day returns mean you can shop with zero risk and change your mind whenever you need to.', 'Shop now', 'Browse collections'],
    ...
    about: ['Quality we actually stand behind', 'We got tired of flimsy products and inflated prices, so we built a shop around two simple ideas: quality that lasts and straight talk you can trust. We only stock things we would happily use ourselves, we price them fairly, and we tell you honestly when something is not the right fit. That is how we would want to be treated as customers, so it is exactly how we run the shop.', 'What we believe', 'Buy better, buy less. Great products, fair prices, and service that treats you like a person, not an order number.'],
  ...
  agency: {
    hero: ['Ideas that move the needle', 'We design brands and campaigns that get noticed and, more importantly, get results. Every engagement starts with your goals and your audience, not a template, so the creative actually performs once it ships. Strategy first, beautiful work always, and a senior team that treats your business like our own.', 'Start a project', 'See our work'],
    ...
    about: ['A studio built on results', 'We are a small team of senior designers, strategists, and marketers who care about outcomes as much as aesthetics. Beautiful work that does not perform is just expensive decoration, so we hold every project to a simple test: did it move the number that matters to you? That focus, plus senior people doing the actual work start to finish, is why our clients keep coming back year after year.', 'How we think', 'Strategy before style, results before awards, and honesty at every step. We win when you win.'],
  ...
  portfolio: {
    hero: ['Work I am proud to share', 'I craft thoughtful, polished projects that help brands and people stand out for the right reasons. From the first rough idea to the final small detail, I sweat the things most people never notice so the finished work feels effortless. Take a look through what I have made, and if it feels like a fit, let us make something together.', 'View my work', 'Get in touch'],
    ...
    about: ['Hi, I am glad you are here', 'I am an independent maker who cares deeply about craft and about the people I work with. I take on only a handful of projects at a time so each one gets my full attention, and I would rather do a few things exceptionally well than spread myself thin across many. When we work together, you get me from the first call to the final handoff, never a junior stand-in behind the scenes.', 'What drives me', 'The joy of making something genuinely good, and the trust of a client who is thrilled with the result. That is the whole job.'],
...
const IMG = {
  ...
  "restaurant": { hero: "https://images.unsplash.com/photo-1521017432531-fbd92d768814?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTc1ODN8MHwxfHNlYXJjaHwxfHxjb3p5JTIwd2FybSUyMG5laWdoYm9yaG9vZCUyMGNhZmUlMjBpbnRlcmlvcnxlbnwxfDB8fHwxNzg5MjY0ODkwfDA&ixlib=rb-4.1.0&q=80&w=1080", about: "https://images.unsplash.com/photo-1694813646547-2212c9cc8490?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTc1ODN8MHwxfHNlYXJjaHwxfHxmcmVzaCUyMGZvb2QlMjBhbmQlMjBjb2ZmZWUlMjBvbiUyMGElMjBjb3VudGVyfGVufDF8MHx8fDE3ODkyNjQ4OTB8MA&ixlib=rb-4.1.0&q=80&w=1080", aboutAlt: "fresh food and coffee served at a cafe table" },
...
const HERO_ALT = {
  ...
  restaurant: 'Warm, inviting neighborhood cafe interior',
